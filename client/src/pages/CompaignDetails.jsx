          ...
          <div className="flex-[2] flex flex-col gap-[40px]">
            <div>
              ...
              <div className="mt-[20px]">
                <p className="font-epilogue leading-[26px] text-justify font-normal text-[16px] text-[#808191]">
                  {state.description}
                </p>
              </div>
            </div>
              ...
              <div className="mt-[20px] flex flex-col gap-4">
                {donators.length > 0 ? (
                  donators.map((donator, index) => (
                    ...
                    >
                      <p
                        className="font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px]
                      break-all"
                      >
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                <h4 className="font-epilogue font-semibold text-[14x] leading-[22px] text-white">
